...
module Hasura.Subscription exposing (OnlineUsersOptionalArguments, TodosByPkRequiredArguments, TodosOptionalArguments, UsersByPkRequiredArguments, UsersOptionalArguments, online_users, todos, todos_by_pk, users, users_by_pk)
...
-}
todos : (TodosOptionalArguments -> TodosOptionalArguments) -> SelectionSet decodesTo Hasura.Object.Todos -> SelectionSet (List decodesTo) RootSubscription
...
-}
todos_by_pk : TodosByPkRequiredArguments -> SelectionSet decodesTo Hasura.Object.Todos -> SelectionSet (Maybe decodesTo) RootSubscription
