...
module Hasura.InputObject exposing (Boolean_comparison_exp, Boolean_comparison_expOptionalFields, Int_comparison_exp, Int_comparison_expOptionalFields, Online_users_bool_exp(..), Online_users_bool_expOptionalFields, Online_users_bool_expRaw, Online_users_order_by, Online_users_order_byOptionalFields, String_comparison_exp, String_comparison_expOptionalFields, Timestamptz_comparison_exp, Timestamptz_comparison_expOptionalFields, Todos_arr_rel_insert_input(..), Todos_arr_rel_insert_inputOptionalFields, Todos_arr_rel_insert_inputRaw, Todos_arr_rel_insert_inputRequiredFields, Todos_bool_exp(..), Todos_bool_expOptionalFields, Todos_bool_expRaw, Todos_insert_input, Todos_insert_inputOptionalFields, Todos_obj_rel_insert_input(..), Todos_obj_rel_insert_inputOptionalFields, Todos_obj_rel_insert_inputRaw, Todos_obj_rel_insert_inputRequiredFields, Todos_on_conflict(..), Todos_on_conflictOptionalFields, Todos_on_conflictRaw, Todos_on_conflictRequiredFields, Todos_order_by, Todos_order_byOptionalFields, Todos_set_input, Todos_set_inputOptionalFields, Users_bool_exp(..), Users_bool_expOptionalFields, Users_bool_expRaw, Users_on_conflict(..), Users_on_conflictOptionalFields, Users_on_conflictRaw, Users_on_conflictRequiredFields, Users_order_by, Users_order_byOptionalFields, Users_set_input, Users_set_inputOptionalFields, buildBoolean_comparison_exp, buildInt_comparison_exp, buildOnline_users_bool_exp, buildOnline_users_order_by, buildString_comparison_exp, buildTimestamptz_comparison_exp, buildTodos_arr_rel_insert_input, buildTodos_bool_exp, buildTodos_insert_input, buildTodos_obj_rel_insert_input, buildTodos_on_conflict, buildTodos_order_by, buildTodos_set_input, buildUsers_bool_exp, buildUsers_on_conflict, buildUsers_order_by, buildUsers_set_input, encodeBoolean_comparison_exp, encodeInt_comparison_exp, encodeOnline_users_bool_exp, encodeOnline_users_order_by, encodeString_comparison_exp, encodeTimestamptz_comparison_exp, encodeTodos_arr_rel_insert_input, encodeTodos_bool_exp, encodeTodos_insert_input, encodeTodos_obj_rel_insert_input, encodeTodos_on_conflict, encodeTodos_order_by, encodeTodos_set_input, encodeUsers_bool_exp, encodeUsers_on_conflict, encodeUsers_order_by, encodeUsers_set_input)
...
buildTodos_on_conflict : Todos_on_conflictRequiredFields -> (Todos_on_conflictOptionalFields -> Todos_on_conflictOptionalFields) -> Todos_on_conflict
